...
## Overview
In this blog post I will be reviewing [Mayunk Bharadwaj](mbha0014@student.monash.edu)'s R package `ozcovid` made for Assignment 2 of ETC5523 containing coronavirus data, functions, and shiny application. The development version from [GitHub](https://github.com/etc5523-2020/r-package-assessment-mayunk264/issues).
