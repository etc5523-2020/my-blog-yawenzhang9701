...
## How lockdown restriction affect citizen daily activity frequency? `r emo::ji("footprints")`
...
Daily
```
Overall, as the pandemic is under control, people's travel frequency has gradually increased, especially for the outdoor activities. For now, Spain has decreased to the first level of lockdown, daily life gradually return to normal. However, face mask are now obligatory at ALL times and keep two meters social distance. Some regions such as Aragon Madrid and Cataluña are currently experiencing outbreaks that has brought back lockdown in some towns and regions. The government is also making regulations based on the current situation. 
