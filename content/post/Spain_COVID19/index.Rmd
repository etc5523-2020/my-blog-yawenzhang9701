---
title: COVID-19 in Spain `r emo::ji("es")`
author: Yawen Zhang
date: '2020-09-14'
...
## About Spain `r emo::ji("es")`

The COVID-19 pandemic in Spain is part of the pandemic of Coronavirus Disease 2019 (**COVID‑19**). Spain has the second highest total confirmed cases in Europe after Russia. The first confirmed cases come from Germany and spread to Spain on 31 Jan 2019. Up to 15 March 2020, all 50 provinces have confirmed cases of the country. Spain became one of the most draconian countries in the world and a lockdown restriction imposed on 14 March 2020. Until 13 Sep, there are about 566,326 confirmed cases and 29,747 deaths. 


## Data Source and Descrptions `r emo::ji("dart")`
The data is taken from the [tidycovid19](https://github.com/joachim-gassen/tidycovid19)[@Spain] package created by Joachim Gassen. The `tidycovid19` package was created to provide transparent access to various data sources. Then, used `download_merged_data` to merge the dataset. This merge dataset contains data of coronavirus confirmed, recovered, death original collected from [Johns Hopkins University](https://github.com/CSSEGISandData/COVID-19)[@Johns_Hopkins].Some other variables contains the frequency places are visited comes from [Google Commmunity Mobility Reports](https://www.google.com/covid19/mobility/)[@Google]. The raw data was stored in two CSV files separately. The data collection date for this blog until September 13, 2020. The following map and plots present these variables in the data set and also contain descriptions.
...
Activity <- data_wrangled %>%
  ...
  annotate(geom = "text", 
           ...
           size = 4, 
           color = "red") +
  ggtitle("The frequency that people visit workplaces and residentia")
Activity
...
The raw data comes from tidycovid19[@Spain].
